    ...
    <div className="h-full bg-sidebar">
      <ScrollArea>
        <div
          ...
          className="group/project cursor-pointer w-full text-left flex  items-center gap-0.5 h-5.5 font-bold bg-accent  "
        >
          <ChevronRightIcon
            className={cn(
          ...
          <div className="opacity-p group-hover/project:opacity-100 transition-none duration-0 flex items-center gap-0.5 ml-auto opacity-0">
            <Button
              size="icon-xs"
              onClick={(e) => {
                e.stopPropagation();
