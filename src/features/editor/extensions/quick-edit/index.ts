  ...
  return [
    {
      ...
      create(view) {
        ...
        dom.className =
          "bg-popover text-popover-foreground z-50 rounded-sm border border-input p-2 shadow-md flex flex-col gap-2 text-sm w-[320px]";
        ...
        input.className =
          "bg-transparent border-none outline-none px-2 py-1 font-sans-100";
        input.autofocus = true;

        const buttonContainer = document.createElement("div");
        buttonContainer.className = "flex justify-between item-center gap-2";
        ...
        form.onsubmit = async (e) => {
          ...
          const selectedCode = editorView.state.doc
